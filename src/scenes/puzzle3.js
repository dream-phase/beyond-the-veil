...
export default class puzzle3 extends Phaser.Scene {
  ...
  create(){
    ...
    var tower2 = new Phaser.Geom.Rectangle((this.scale.width/2)-350, 100 , 20, 380);
    var tower3 = new Phaser.Geom.Rectangle((this.scale.width/2)+350, 100 , 20, 380);
    ...
    this.ring1 = new Phaser.Geom.Rectangle((this.scale.width/2)-360,100, 100,50);
    this.ring2 = new Phaser.Geom.Rectangle((this.scale.width/2)-360,150, 100,50);
    this.ring3 = new Phaser.Geom.Rectangle((this.scale.width/2)-360,200, 100,50);
    this.ring4 = new Phaser.Geom.Rectangle((this.scale.width/2)-360,250, 100,50);
    this.ring5 = new Phaser.Geom.Rectangle((this.scale.width/2)-360,300, 100,50);
    this.ring6 = new Phaser.Geom.Rectangle((this.scale.width/2)-360,350, 100,50);
